#I declare that my work contains no examples of misconduct such,or collusion.
...
#asking whether the user want to continue or quit
def user():
    global H
